                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4 text-center">
                            ...
                            <div class="col-lg-3 text-center" style="text-align: center">
                                <a href="https://mpago.la/2SfbMpR">
                                    <img src="{{ asset('home/img/mercado-pago.png') }}" style="width: 200px" alt="">
                                </a>
                            </div>
                            <div class="col-lg-3" style="text-align: center">
                                <a href="{{ route('home.pages.pagamento.qrcode') }}">
                                    <img src="{{ asset('home/img/Pix.jpeg') }}" style="width: 200px" alt="">
                                </a>
                            </div>
                            <div class="col-lg-3"></div>
                        </div>
